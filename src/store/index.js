...
export default createStore({
  ...
  actions: {
    ...
    async bookRoom({commit},{user_id,room_id,check_in, check_out}){
      let {data} = await axios.post(`${coastalURL}booked/manageRoom`,{user_id:user_id,room_id,check_in, check_out});
      console.log(data);
    },
  },
